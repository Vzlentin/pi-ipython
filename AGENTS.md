...
- Keep `extensions/ipython.py` from shadowing installed Python packages. Its early `sys.path` cleanup and the extension-owned kernelspec override are deliberate.
